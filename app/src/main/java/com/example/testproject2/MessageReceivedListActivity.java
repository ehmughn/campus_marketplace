...
public class MessageReceivedListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_received_list);
        ...
        recyclerView = findViewById(R.id.messageReceived_recyclerView);
    ...
    private void countMessages() {
        String url = "http://" + DatabaseConnectionData.getHost() +"/numart_db/get_message_received_count.php?current_user=" + CurrentAccount.getAccount().getId();
    ...
    private void loadMessages(int reccursion, int end) {
        ...
        String url = "http://" + DatabaseConnectionData.getHost() +"/numart_db/select_message_received.php?offset=" + reccursion + "&current_user=" + CurrentAccount.getAccount().getId();
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        rooms.add(new ChatRoom(
                                ...
                                jsonObject.getString("buyer_name"),
